            ...
            <table className="w-full border-collapse text-center">
              <thead>
                <tr className="bg-muted">
                  <th className="border p-2">Leverage Point</th>
                  <th className="border p-2">Category</th>
                  <th className="border p-2">Why Important</th>
                  <th className="border p-2">Expected Impact</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="border p-2">
                    ...
                    shift public preference back to rail.
                  </td>
                  <td className="border p-2">
                    Increased rail usage, better load balancing between
                    transport modes.
                  </td>
                </tr>
                <tr>
                  <td className="border p-2">
                    Public Perception / Status of Travel Mode
                  </td>
                  <td className="border p-2">Paradigm (#2)</td>
                  <td className="border p-2">
                  ...
                  <td className="border p-2">
                    Reduction in unnecessary air travel; improved utilization of
                    rail.
                  </td>
                </tr>
                <tr>
                  <td className="border p-2">
                    Government Funding Criteria for Railways
                  </td>
                  <td className="border p-2">Rules of the System (#5)</td>
                  <td className="border p-2">
                    Current investment favors aviation. Changing funding logic
                    to reward service quality and passenger experience can fix
                    structural neglect.
                  </td>
                  <td className="border p-2">
                    Enhanced rail service, reinvestment cycles, increased
                    satisfaction.
                  </td>
                </tr>
                <tr>
                  <td className="border p-2">
                    Search Pricing Algorithms in Airlines
                  </td>
        ...
        <section>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-center">
              <thead>
                <tr className="bg-muted">
                  <th className="border p-2">System Archetype</th>
                  <th className="border p-2">Where It Appears</th>
                  <th className="border p-2">Impact on the System</th>
                  <th className="border p-2">How to Address It</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="border p-2">
                    Creates a self-reinforcing loop where air travel dominates
                    and rail collapses further.
                  </td>
                  <td className="border p-2">
                    Rebalance policy and investment across both sectors to
                ...
                <tr>
                  ...
                  <td className="border p-2">
                    Tatkal schemes, superficial upgrades, and booking fixes
                    treat symptoms without addressing root causes in railways.
                  </td>
                  <td className="border p-2">
                    Diverts attention from deeper structural reforms needed in
                    infrastructure, hygiene, and trust.
                  </td>
                  <td className="border p-2">
                    Focus on long-term structural fixes like governance reform,
                ...
                <tr>
                  ...
                  <td className="border p-2">
                    Leads to systemic apathy and a normalization of substandard
                    conditions.
                  </td>
                  <td className="border p-2">
                    Set and enforce higher service standards and communicate
                    progress transparently to the public.
                  </td>
                </tr>
              </tbody>
            </table>
